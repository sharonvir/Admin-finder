...
\033[96m
+=========================================+
|.........BLACK GUARD ADMIN FINDER ..........|
+-----------------------------------------+
|#Author:     MR.D3F417                   |
|#Contact: mrroobtha3@gmail.com           |
|#Date:          7/3/2022                 |
|#This tool is made for pentesting.       |
|#Discord : MR.D3F417#8277                |
|#Creator : BLACK GUARD TEAM              |
|#All links : https://zil.ink/mrd3f417    |
+=========================================+
|.........BLACK GUARD ADMIN FINDER...........|
+-----------------------------------------+
''')
...
print("                                                                       ")
url = input("\033[97m [BG] enter the website : ")
...
print ("----------------------------------------------------------------------------------------")
print ("\033[93m     i HOPE I HAVE HELPED YOU ^_^ , TY FOR USE MY SCRIPT -MR.D3F417-")
print ("----------------------------------------------------------------------------------------")
